...
public class WalletServiceTest
{
    ...
    // Since the wallet is a mock object, and the id is generated by the database, we
    // need to simulate the id of the wallet
    private Long m_wallet1Id;
    private Long m_wallet2Id;
    ...
    {
        when(m_walletRepository.findById(m_wallet1Id))
            .thenReturn(Optional.of(m_wallet1));

        m_walletService.DeleteWallet(m_wallet1Id);
    ...
    {
        when(m_walletRepository.findById(m_wallet1Id)).thenReturn(Optional.empty());
    ...
    public void TestArchiveWallet()
    {
        ...
        m_walletService.ArchiveWallet(m_wallet1Id);
    ...
    TestUpdateWalletBalanceDoesNotExist()
    {
        ...
        assertThrows(RuntimeException.class,
                     () -> m_walletService.UpdateWalletBalance(m_wallet1Id, 1000.0));
    ...
    public void TestTransferMoneySuccess()
    {
        ...
        when(m_walletRepository.findById(m_wallet1Id))
            .thenReturn(Optional.of(m_wallet1));
        when(m_walletRepository.findById(m_wallet2Id))
        ...
        m_walletService.TransferMoney(m_wallet1Id,
                                      m_wallet2Id,
        ...
        verify(m_walletRepository).findById(m_wallet1Id);
        verify(m_walletRepository).findById(m_wallet2Id);
        verify(m_walletRepository).save(m_wallet1);
    ...
    public void TestTransferMoneyReceiverDoesNotExist()
    {
        ...
        when(m_walletRepository.findById(m_wallet2Id)).thenReturn(Optional.empty());
    ...
    public void TestAddConfirmedIncome()
    {
        ...
        m_walletService.AddConfirmedIncome(m_wallet1Id,
                                           m_category,
                                           m_date,
                                           m_incomeAmount,
                                           m_description);
    ...
    public void TestAddPendingIncome()
    {
        ...
        m_walletService.AddPendingIncome(m_wallet1Id,
                                         m_category,
                                         m_date,
                                         m_incomeAmount,
                                         m_description);
    ...
    public void TestAddConfirmedExpense()
    {
        ...
        m_walletService.AddConfirmedExpense(m_wallet1Id,
                                            m_category,
                                            m_date,
                                            m_expenseAmount,
                                            m_description);
    ...
    public void TestAddPendingExpense()
    {
        ...
        m_walletService.AddPendingExpense(m_wallet1Id,
                                          m_category,
                                          m_date,
                                          m_expenseAmount,
                                          m_description);
